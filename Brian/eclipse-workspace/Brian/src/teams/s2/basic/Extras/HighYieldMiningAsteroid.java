...
public class HighYieldMiningAsteroid extends MiningAsteroid {

	protected Miner[] minersInQueue;

	private HighYieldAsteroid asteroid;
	private boolean open;

	public HighYieldMiningAsteroid(HighYieldAsteroid a) throws SlickException {
